  ...
  return (
    <>
      ...
      <Sequence from={SCENES.INTRO.start} durationInFrames={SCENES.INTRO.duration}>
        <IntroScene />
        <Audio src={staticFile("audio/en/intro.mp3")} />
      </Sequence>
      ...
      <Sequence from={SCENES.TWO_FACES.start} durationInFrames={SCENES.TWO_FACES.duration}>
        <TwoFacesScene />
        <Audio src={staticFile("audio/en/twoFaces.mp3")} />
      </Sequence>
      ...
      <Sequence from={SCENES.NEOLIBERALISM.start} durationInFrames={SCENES.NEOLIBERALISM.duration}>
        <NeoliberalismScene />
        <Audio src={staticFile("audio/en/neoliberalism.mp3")} />
      </Sequence>
